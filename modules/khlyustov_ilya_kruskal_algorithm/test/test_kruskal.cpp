...
TEST(Kruskal_Algorithm, ClassicalCase1) {
  size_t nodes = 5;
  std::vector<Edge> edges = {
      Edge(1, 2, 1), Edge(0, 1, 2), Edge(2, 3, 3),
      Edge(2, 4, 4), Edge(4, 3, 5), Edge(1, 4, 6),
  };
...
TEST(Kruskal_Algorithm, ClassicalCase2) {
  size_t nodes = 5;
  std::vector<Edge> edges = {
      Edge(1, 2, 1), Edge(0, 1, 2), Edge(0, 2, 3),
      Edge(2, 4, 4), Edge(4, 3, 5), Edge(1, 4, 6),
  };
...
TEST(Kruskal_Algorithm, AddEdgeFunctionality) {
  ...
  for (auto edge : {Edge(1, 2, 1), Edge(0, 1, 2), Edge(0, 2, 3), Edge(2, 4, 4),
                    Edge(4, 3, 5), Edge(1, 4, 6)}) {
